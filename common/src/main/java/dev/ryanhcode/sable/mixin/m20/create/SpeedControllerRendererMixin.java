...
@Mixin(targets = "com.simibubi.create.content.kinetics.speedController.SpeedControllerRenderer", remap = false)
public class SpeedControllerRendererMixin {
    @WrapOperation(
    ...
    private boolean sable$allowSpeedControllerBer(final LevelAccessor level,
                                                  final Operation<Boolean> original,
                                                  final SpeedControllerBlockEntity blockEntity,
        ...
        return SableCreateRenderBridge.visualizationSupportedForSableBer(level,
                original.call(level),
                blockEntity,
                "SpeedControllerRenderer",
                "Create_SpeedControllerRenderer_rotatingShaftAndBracket");
    }
}
