...
/** Reuses Create's own ArmRenderer articulated BER path for Sable-contained Mechanical Arms. */
@Mixin(targets = "com.simibubi.create.content.kinetics.mechanicalArm.ArmRenderer", remap = false)
public class ArmRendererMixin {
    private static final Set<String> LOGGED_ARM_BER = Collections.newSetFromMap(new ConcurrentHashMap<>());

    @WrapOperation(
            method = "renderSafe(Lcom/simibubi/create/content/kinetics/mechanicalArm/ArmBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V",
    ...
    private boolean sable$allowArmVanillaBer(final LevelAccessor level,
                                             final Operation<Boolean> original,
                                             final ArmBlockEntity blockEntity,
